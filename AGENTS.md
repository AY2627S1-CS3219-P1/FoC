...
Add or update a landmine after reproducing a non-obvious failure that can affect future work. Do not add one-off command mistakes or unverified explanations. Do not add a landmine if you fixed the cause and the same failure or triggering agent behavior cannot recur.
