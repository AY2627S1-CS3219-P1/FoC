...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/AY2627S1-CS3219-P1/FoC/pkg/gen/user/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HealthServiceName = "user.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/user.v1.HealthService/Check"
)

// HealthServiceClient is a client for the user.v1.HealthService service.
type HealthServiceClient interface {
	Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error)
}

// NewHealthServiceClient constructs a client for the user.v1.HealthService service. By default, it
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_user_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls user.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the user.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/user.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("user.v1.HealthService.Check is not implemented"))
}
