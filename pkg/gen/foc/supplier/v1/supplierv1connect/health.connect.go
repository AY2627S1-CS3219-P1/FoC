...
package supplierv1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/AY2627S1-CS3219-P1/FoC/pkg/gen/foc/supplier/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HealthServiceName = "foc.supplier.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/foc.supplier.v1.HealthService/Check"
)

// HealthServiceClient is a client for the foc.supplier.v1.HealthService service.
type HealthServiceClient interface {
	Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error)
}

// NewHealthServiceClient constructs a client for the foc.supplier.v1.HealthService service. By
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_foc_supplier_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls foc.supplier.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the foc.supplier.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/foc.supplier.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("foc.supplier.v1.HealthService.Check is not implemented"))
}
